...
int Settings::BLOCKS_PER_ROW = 60;
Settings::Quality Settings::OUTPUT_QUALITY = Settings::QUALITY_MAXIMUM;
...
int Settings::SAFE_ERROR_NUMBER = 1000;
int Settings::LOSS_DIVISION = 3;
